...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo CHtml::activeDropDownList($model,'id_tipo',Tipo::model()->listaTipos(),array('empty'=>'Escolha um tipo')); ?>
		<?php echo $form->error($model,'id_tipo'); ?> 
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'id_banda'); ?>
		<?php echo CHtml::activeDropDownList($model,'id_banda',Banda::model()->listaBandas(),array('empty'=>'Escolha uma banda')); ?>
